...
export default function MassMail() {
  ...
  return (
    <div className="p-6 lg:p-10 ml-40 mt-20">
        ...
        {results ? (
          ...
          <div className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-foreground mb-1.5">Sender Gmail</label>
                <input
                  type="email"
                  value={senderEmail}
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 py-2.5 rounded-lg border border-input bg-background text-foreground text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-shadow resize-none font-mono"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={7}
                className="w-full px-3 py-2.5 rounded-lg border border-input bg-background text-foreground text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-shadow resize-none"
              />
            </div>
            ...
            <button
              onClick={handleSend}
              disabled={loading}
              className="w-full h-10 rounded-lg bg-primary cursor-pointer text-primary-foreground text-sm font-medium flex items-center justify-center gap-2 hover:opacity-90 transition-opacity disabled:opacity-50"
            >
              {loading ? (
